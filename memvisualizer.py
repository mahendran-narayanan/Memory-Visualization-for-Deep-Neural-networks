...
class Page2(Page):
    def __init__(self, *args, **kwargs):
        ...
        fig.add_subplot(422).plot(t.iloc[:,4])
        fig.add_subplot(422).set_title("Model 1: Energy")
        fig.add_subplot(423).plot(t.iloc[:,3])
        fig.add_subplot(423).set_title("Model 2: Memory")
        fig.add_subplot(424).plot(t.iloc[:,4])
        fig.add_subplot(424).set_title("Model 2: Memory")
        fig.add_subplot(425).plot(t.iloc[:,3])
        fig.add_subplot(425).set_title("Model 3: Memory")
        fig.add_subplot(426).plot(t.iloc[:,4])
        fig.add_subplot(426).set_title("Model 3: Memory")
        fig.add_subplot(427).plot(t.iloc[:,3])
        fig.add_subplot(427).set_title("Model 4: Memory")
        fig.add_subplot(428).plot(t.iloc[:,4])
        fig.add_subplot(428).set_title("Model 4: Memory")
